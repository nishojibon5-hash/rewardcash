/**
 * Multi-platform Streaming Worker
 * Automatically selects best streaming method:
 * 1. WebAssembly FFmpeg (Client-side, works on mobile)
 * 2. Server-side FFmpeg (Desktop/Server)
 * 3. Simple Pass-through (Fallback)
 */
...
export interface StreamSession {
  ...
  videoUrl: string;
  platforms: string[];
  status: "preparing" | "loading" | "processing" | "streaming" | "stopped";
